...
local function register_storage_store(_, image, _, tmp_exp_path, _, _, _, _)
  ...
  if success then
    ...
    print('Upload failed: ' .. imagename)
    msgout("Failed to export " .. imagename)
  end
end
...
local export_widgets =
  ...
  dt.new_widget("box") {
    orientation = "horizontal",
    dt.new_widget("label") {label = "Language code:",
      tooltip = "Description language code (eg: en, fr, ...)."
      .. "More descriptions can be entered in the tags (eg: {{fr|Une description}}"},
    language_widget
  }
}
